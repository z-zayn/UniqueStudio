class HeapPriQueue(object):
    ...
    def siftup(self, e, last):  # 向上筛选
         ...
         elems[i] = e  # 如果i已经更新为0了，直接将e的值赋给位置0.或者需要插入的元素大于当前父结点的值，则将其赋给当前父结点的子结点
    ...
    def siftdown(self, e, begin, end):  # 向下筛选
        ...
        elems[i] = e  # 如果e已经是某个子树3者中最小的元素，则将其赋给这个子树的父结点或者位置i已经更新到叶结点位置，则将e赋给这个叶结点。
...
if __name__ == "__main__":
    temp = HeapPriQueue([5, 6, 8, 1, 2, 4, 9])
    print(temp._elems)
    temp.dequeue()
    print(temp._elems)
    temp.enqueue(0)
